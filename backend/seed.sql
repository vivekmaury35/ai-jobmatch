...
CREATE TABLE IF NOT EXISTS analyses (
    ...
    experience_years_candidate FLOAT DEFAULT 0.0,
    experience_years_required FLOAT DEFAULT 0.0,
    experience_gap_years FLOAT DEFAULT 0.0,
    education_gate VARCHAR(50),
